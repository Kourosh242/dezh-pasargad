...
fun SearchScreen(
    ...
    // The M3 SearchBar on this dedicated screen is permanently active and
    // swallows system back — without this route the user was STUCK here.
    // Both its collapse and a system back press leave the screen.
